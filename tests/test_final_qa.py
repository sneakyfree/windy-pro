...
check('bundle_audio_format', "format: 'opus'" in vr)
check('bundle_video_format', "format: 'vp9'" in vr)
check('bundle_transcript', 'transcript' in vr and 'segments' in vr)
check('bundle_device', "platform: 'desktop'" in vr)
check('bundle_sync_status', 'sync_status' in vr)
