...
// Minimal authed-fetch — apiFetch in Dashboard.jsx isn't exported, so we
// inline a thin equivalent here. Returns null on any failure (the view's
// useLiveVitals retains the last good values).
    ...
    return (
        <div className="echo-shell">
            ...
            <div className="echo-locbar">
                ...
                <span>🖥️ {friendlyHost}</span>
                {geo.ip && <span>🌐 {geo.ip}</span>}
