...
// Local Only defaults ON: the local engine is the only path that works without
// a cloud API key, so an unchecked default made every Live Listen chunk fail
// out of the box for keyless users. Persist the user's explicit choice.
