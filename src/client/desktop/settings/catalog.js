...
const CATALOG = {
  ...
  'engine.micDeviceLabel': {
    type: 'string',
    description: 'Human-readable label of the selected microphone (e.g. "Grant\'s iPhone Microphone"). Used to re-find the device when its deviceId drifts between sessions (Continuity devices re-enumerate with new ids). Maintained automatically by the picker; empty for "default"/"phone:wifi".',
    default: '',
    restartRequired: false,
  },
  ...
  'engine.cameraDeviceLabel': {
    type: 'string',
    description: 'Human-readable label of the selected camera (e.g. "Grant\'s iPhone Camera"). Used to re-find the device when its deviceId drifts between sessions (Continuity Camera re-enumerates with new ids). Maintained automatically by the picker; empty for "default"/"phone:wifi".',
    default: '',
    restartRequired: false,
    tags: ['archive'],
  },
