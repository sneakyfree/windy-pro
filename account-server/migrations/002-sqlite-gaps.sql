...
--
--  This migration ships the missing tables. All use TEXT for
--  timestamps (to match the SQLite DDL + avoid coercing the call-
--  site code) and INTEGER for boolean-ish columns (0/1) for the
--  same reason as 001's INTEGER/BOOLEAN fix.
--
...
BEGIN
    ...
    INSERT INTO schema_migrations (version, description) VALUES
        ('002', 'Port remaining SQLite-only tables (mfa, otp, webhook_deliveries, analytics, Wave 8 broker)');
END $$;
