-- ════════════════════════════════════════════════════════════════
--  Windy Pro — PostgreSQL Schema
--  Phase 7A-2: Equivalent of the SQLite schema with proper PG types
--
--  Run this once to create all tables, or use the migration script.
